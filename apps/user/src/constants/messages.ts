export const USERS_MESSAGES = {
  ...
  REGISTER_SUCCESS: 'Register successfully. Check your email to verify the organization.',
  JOIN_SUCCESS: 'Join successfully. Now you can log in by your own account.',
  INVITE_SUCCESS: 'Invite successfully',
  REVOKE_SUCCESS: 'Revoke successfully',
  REMOVE_SUCCESS: 'Remove member successfully',
  ...
  GET_ORG_SUCCESS: 'Get organization profile success',
  GET_INVITE_SUCCESS: `Get organization's invitation success`,
