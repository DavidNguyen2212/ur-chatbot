...
def get_embedder():
    return OpenAIEmbeddings(
        model="text-embedding-3-small", api_key=configService.OPENAI_API_KEY
    )
...
@lru_cache(maxsize=1)
def get_chain(
    company_name: str, chatbot_attitude: str, start_sentence: str, end_sentence: str
):
    retrieval_qa_chat_prompt, _ = get_prompts(
        company_name, chatbot_attitude, start_sentence, end_sentence
    )
    model = get_model()
...
"""
# async def parallel_response_from_LLM(
#     chat_id: str,
#     query: str,
#     db_host: str,
#     namespace_1: str,
...
#         company_name, chatbot_attitude, start_sentence, end_sentence
#     )
#     history_aware_retriever_1 = get_history_aware_retriever(
#         db_host,
#         namespace_1,
#         company_name,
#         chatbot_attitude,
...
#         end_sentence,
#     )
#     history_aware_retriever_2 = get_history_aware_retriever(
#         db_host,
#         namespace_2,
#         company_name,
#         chatbot_attitude,
...
#     # Tạo hai pipeline
#     ragChain1 = create_retrieval_chain(
#         retriever=history_aware_retriever_1, combine_docs_chain=question_answer_chain
#     )
#     ragChain2 = create_retrieval_chain(
#         retriever=history_aware_retriever_2, combine_docs_chain=question_answer_chain
#     )
